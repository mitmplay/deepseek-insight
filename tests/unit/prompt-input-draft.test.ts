/**
 * PromptInput × draft persistence (2026-08-30, HMR DX): typing saves to
...
describe('PromptInput — debounced draft save', () => {
...
describe('PromptInput — HMR strike (teardown flush + remount restore)', () => {
...
describe('PromptInput — blur flush and clear paths', () => {
