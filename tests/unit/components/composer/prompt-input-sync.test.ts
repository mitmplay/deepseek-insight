/**
 * Composer × Prompt Sync (ADR "The Prompt Sync", 2026-09-04) — the
...
import LensComposerHost from '../../LensComposerHost.svelte';
import {
	isSyncChecked,
	pushSharedText,
	registerSyncMember,
