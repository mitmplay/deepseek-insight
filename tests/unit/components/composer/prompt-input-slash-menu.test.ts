/**
 * Composer × Slash Menu (task 2.2-T): the trigger grammar (a `/`
...
describe('Composer × SlashMenu — trigger grammar', () => {
...
describe('Composer × SlashMenu — kind-aware picks', () => {
...
describe('Composer × SlashMenu — DSI gesture rows (ADR §1.1 layer A)', () => {
...
describe('Composer × SlashMenu — the ? help shape stands the menu down', () => {
...
describe('Composer × SlashMenu — row-gated keyboard guard', () => {
...
describe('Composer × SlashMenu — the bridge + draft persistence', () => {
