/**
 * Composer × Command Help integration (command-help, 2026-08-30):
...
describe('Composer × CommandHelpCard', () => {
...
describe('Composer × CommandHelpCard — host vocabulary (catalog-fed)', () => {
