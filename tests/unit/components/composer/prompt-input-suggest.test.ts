/**
 * Composer × Suggest Strip integration (task 2.3-T): trigger typing →
...
describe('Composer × SuggestStrip — fetch + debounce', () => {
...
describe('Composer × SuggestStrip — accept (press 1 / press 2)', () => {
...
describe('Composer × SuggestStrip — Esc memo (BC-9)', () => {
...
describe('Composer × SuggestStrip — IME composition (BC-8)', () => {
...
describe('Composer × SuggestStrip — locked state clears the strip', () => {
...
describe('Composer × SuggestStrip — ordinary sends unaffected (regression)', () => {
...
describe('Composer × SuggestStrip — the run-shape ladder refuses (Prompt Sync amendment 2026-09-04)', () => {
...
describe('Composer × SuggestStrip — the broadcast slash hand (amended 2026-09-04)', () => {
...
describe('Composer × SuggestStrip — the sidebar broadcast (Prompt Sync)', () => {
...
describe('Composer × SuggestStrip — trigger priority beside the Slash Menu (2.2-T)', () => {
	const slashProps = () => ({
