 ...
 * (Resolved decision 6: the strip's row-gated guard lives in PromptInput's
...
} from '$lib/components/chat/SlashMenu.svelte';
...
describe('SlashMenu — sections + order', () => {
	it('renders the three labeled sections — DSI gestures above Commands above Skills — rows in order', () => {
		...
		// MENU_GESTURES order — /promptmanager joined 2026-09-06 (D7 menu
		// row); /dsisettings + /dshsettings joined 2026-09-07 (Settings
