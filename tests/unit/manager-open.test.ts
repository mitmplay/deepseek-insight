 ...
 * the Prompts Manager through PromptInput's document.body portal host (BC-7 —
 ...
 * is PromptInput-owned: the manager-level harness mounts the modal in-tree
