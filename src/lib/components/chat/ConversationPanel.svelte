<script lang="ts">
	...
	import ConversationError from '$lib/components/chat/ConversationError.svelte';
	...
	import ConversationFloatingAnchor from '$lib/components/chat/ConversationFloatingAnchor.svelte';
	import A2aChipStack from '$lib/components/chat/A2aChipStack.svelte';
